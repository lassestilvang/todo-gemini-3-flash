# Gemini Tasks - Project Progress

## 🚀 Core Infrastructure
- [x] Bun + Next.js 15 App Router setup
- [x] Prisma + SQLite (Better-SQLite3 adapter)
...
- [x] User can create custom lists
- [x] Set list color and emoji icon
- [x] Sidebar list navigation

## 📝 Tasks
- [x] Create tasks with Name and Date
- [x] Toggle completion status
- [x] Delete tasks
- [x] Edit Task Description
- [x] Set Task Priority (High, Medium, Low, None)
- [x] Set Task Deadline
- [x] Set Task Reminders
- [x] Task Estimates (minutes) and Actual time (minutes)
- [x] Labels support (multiple + icon)
- [x] Sub-tasks / Checklist support
- [x] Recurring Tasks (Daily, Weekly, etc.)
- [x] Attachments
- [x] Activity Log (viewable change history)
...
- [x] "Upcoming" view
- [x] "All Tasks" view
- [x] Toggle visibility of completed tasks per view
- [x] Sidebar task counts
- [x] Overdue tasks highlighted with badge count (Sidebar)
- [x] Command Menu (Cmd+K)
- [x] Fast fuzzy search for tasks
